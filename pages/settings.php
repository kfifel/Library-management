<?php
    include_once '../admin/database/dbConnexion.php';
    ...
    global $conn;
    $res = $conn->query("SELECT * FROM manager WHERE id = ".$_SESSION['id_admin']);
    if(!$res):
                        ...
                        <div class="d-grid gap-3">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="first_name" id="first_name" value="<?=$admin['first_name'];  ?>" placeholder="Prénom" class="form-control">
                                </div>
                                <div class="col-6">
                                    <label for="last_name" class="text-white">Nom: </label>
                                    <input type="text" name="last_name" id="last_name" value="<?=$admin['last_name'];?>"  placeholder="Nom" class="form-control">
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                <label for="password2" class="text-white">mot de passe: </label>
                                <input type="password" name="password2" id="password2" placeholder="mot de passe" class="form-control">
                            </div>
                        </div>
                        <div class="d-flex justify-content-between my-4">
                            <input type="submit" value="Enregistrer" name="modifier-admin" class="btn btn-primary form-control">
                        </div>
                    </form>
                </div>
            </div>
